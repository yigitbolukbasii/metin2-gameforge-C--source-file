...
{
    /// <summary>
    ///   Represents the final handshake packet.
    /// </summary>
    internal class HandshakeClosePacket : IPacket
    {
        /// <summary>
        ///   initialize an instance of HandshakeClosePacket.
        /// </summary>
        internal HandshakeClosePacket()
        {
            Data = new byte[2];
            Data[0] = Id;
            Data[1] = 0x02;
        ...
        public byte Id
        {
            get { return (byte) OutPackets.HandshakeClosePacket; }
        }
