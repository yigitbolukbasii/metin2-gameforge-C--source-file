...
namespace Metin2ServerEmulatorCommon.LocalNetwork.Packets.Game
{
    [Serializable]
    public class SessionRequestPacket : IPacket
    {
        public SessionRequestPacket(string username, uint sessionId)
        {
            Username = username;
            SessionID = sessionId;
        }
        ...
        public int Id
        {
            get { return (int) GamePackets.SessionRequestPacket; }
        }
