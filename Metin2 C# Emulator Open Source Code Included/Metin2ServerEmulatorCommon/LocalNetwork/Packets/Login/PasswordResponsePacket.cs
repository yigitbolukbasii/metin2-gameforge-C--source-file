...
{
    [Serializable]
    public class PasswordResponsePacket : IPacket
    {
        public PasswordResponsePacket(PasswordResponse response)
        {
            Response = response;
        }

        public PasswordResponse Response { get; private set; }

        #region IPacket Members

        public int Id
        {
            get { return (int) LoginPackets.PasswordResponsePacket; }
        }
